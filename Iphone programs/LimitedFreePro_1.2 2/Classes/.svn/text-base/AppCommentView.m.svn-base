...
-(void)bindItem{
	if(self._currentAppComment != nil){
		...
		if([_dateArr count] == 3){
			self._dateLabel.text = [NSString stringWithFormat:@"%i年%i月%i日",[[_dateArr objectAtIndex:0] intValue],[[_dateArr objectAtIndex:1] intValue],[[_dateArr objectAtIndex:2] intValue]];
		}
